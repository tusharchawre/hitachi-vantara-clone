  ...
  return (
    <div className='w-full h-screen bg-gradient-to-r from-[#CC2F2A] via-[#CC2F2A] to-[#F07939] flex items-center text-white'>
        <div className='flex justify-between max-w-6xl mx-auto px-4 -translate-y-12'>
           <div className='md:w-[60%] py-8 flex flex-col gap-4'>
           <h1 className='font-extrabold md:text-[4rem] leading-none text-[2rem]'>
           ...
           <div>
            <Image 
            className='rounded-3xl w-[21rem] -translate-x-12 shadow-2xl hidden md:block'
            height={500} 
            width={500} 
