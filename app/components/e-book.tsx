...
export function Ebook() {
  return (
    <div className='w-full h-screen bg-black flex items-center justify-center text-white'>
        <div className='w-3/4 h-[55%] border border-white/50 rounded-xl overflow-hidden flex justify-between flex-col md:flex-row'>
        <div className='md:w-[60%] py-8 flex flex-col gap-4 px-16'>
        <h1
        className='md:text-[3rem] leading-none font-bold mt-8 mb-4'
